...
link repostery su github: https://github.com/JohnnyYuVe/esercizi
Progetto realizzato individualmente dal sottoscritto (Yu John Veneth)


-	Come per prima cosa ho creato un repostery su github in remoto così da poter fare "commit" tramite le command linee su windows(non per forza in quanto git fornisce anche essa una linea di comando sulla quale lanciare comandi).

-	Per poter fare commit da remoto ho scaricato git e ho sincronizzato il mio repostery su github con quello locale
